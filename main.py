...
class ChatApp:
    def __init__(self, model="gpt-3.5-turbo", load_file=''):
        ...
        openai.api_key = "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"  # Define a chave da API do OpenAI
...
os.environ["OPENAI_API_KEY"] = "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"  # Define a chave da API do OpenAI
...
role = "You are a helpful assistant"  # Papel do assistente na conversa
